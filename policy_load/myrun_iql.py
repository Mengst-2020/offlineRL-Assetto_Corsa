...
def train_mydataset(args=get_args(),Path_1=None,Path_2=None):
    from getdata import get_mydataset,make_env 
    dataset = get_mydataset(Path_1)
    if Path_2:
        dataset2 = get_mydataset(Path_2)
        for key in dataset:
            print(key)
            dataset[key]=np.concatenate((dataset[key],dataset2[key]),axis=0)
            print(dataset[key])
    env=make_env()
    ...
    with open(Path_1+'metadata.json', 'r', encoding='utf-8') as f:
...
if __name__ == "__main__":
    train_mydataset(Path_1='/home/mengst/.minari/datasets/SAC/monza-v4/data/')
    # train_mydataset(Path_1='/home/mengst/.minari/datasets/SAC/monza-v4/data/',Path_2='/home/mengst/.minari/datasets/SAC/barcelona-v4/data/')