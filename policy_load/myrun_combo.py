...
def train_mydataset(args=get_args(),Path=None):
    # create env and dataset
    # env = gym.make(args.task)
    from getdata import get_mydataset,make_env,termination_fn_point2dwallenv
    env=make_env()
...
def PolicyNetwork(args=get_args(),Path='/home/mengst/.minari/datasets/SAC/monza-v4/data/'):
    ...
    scaler = StandardScaler()
    termination_fn = getdata.termination_fn_point2dwallenv
    dynamics = EnsembleDynamics(
        dynamics_model,
        dynamics_optim,
        scaler,
    ...
    load_filepath = "model_offline/monza_log/combo/seed_1&timestamp_25-0408-213242/model/policy.pth"
    # load_filepath = "log/ac/combo/seed_1&timestamp_25-0421-194845/model/policy.pth"
