...
def PolicyNetwork(args=get_args(),Path='/home/mengst/.minari/datasets/SAC/monza-v4/data/'):
    ...
    dynamics_scaler = StandardScaler()
    termination_fn = obs_unnormalization(getdata.termination_fn_point2dwallenv, obs_mean, obs_std)
    dynamics = EnsembleDynamics(
        dynamics_model,
        dynamics_optim,
        dynamics_scaler,
    ...
    load_filepath = "model_offline/monza_log/rambo/seed_0&timestamp_25-0413-214639/model/rambo_pretrain.pth"
